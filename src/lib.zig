...
// A simple recursive py_db implementation.
...
pub const py_db = py.class(struct {
    pub const __doc__ = "A class that computes the py_db numbers.";
    ...
    // Get an iterator over the first `self.first_n` py_db numbers.
...
pub const FibonacciIterator = py.class(struct {
    pub const __doc__ = "An iterator that computes the py_db numbers.";
